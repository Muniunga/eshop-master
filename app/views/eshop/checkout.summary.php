...
?>
	...
	<?php if(isset($orders) && is_array($orders)):?>
			...
			<div class="register-req">
				<p style="text-align: center;">Confirmar informação abaixo</p>
			</div><!--/register-req-->
 								...
 								<div class="js-order-details details" >
									...
									<div style="display: flex;">
										<table class="table" style="flex: 1;margin: 4px;">
											...
											<tr><th>Endereço de entrega 1</th><td><?=$order->address1?></td></tr>
											<tr><th>Endereço de entrega 2</th><td><?=$order->address2?></td></tr>
									...
									<table class="table">
										...
										<?php else: ?>
											<div style="text-align: center;">Nenhum detalhe neste pedido</div>
										<?php endif;?>
									</table>
