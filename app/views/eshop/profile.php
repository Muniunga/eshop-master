...
<?php if(is_object($profile_data)): ?>
	...
	<div class="col-md-4 mb" style="flex:1;background-color: #eee;text-align: center;box-shadow: 0px 0px 20px #aaa; border: solid thin #ddd;">
		...
		<div class="white-panel pn">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<p id="user_text" class="small mt">TOTAL GASTO</p>
					<p>$ 47,60</p>
				</div>
			...
			<div class="row">
				<div class="col-md-6">
					<p id="user_text" class="small mt" style="cursor: pointer;color: #13b8ea;"><i class="fa fa-edit"></i> EDITAR</p>
 				</div>
				<div class="col-md-6">
					<p id="user_text" class="small mt" style="cursor: pointer;color:#e18b57;">APAGAR</p>
 				</div>
	...
	<?php if(is_array($orders)):?>
			...
			<table class="table">
				<thead>
					<tr><th>Pedido no</th><th>DATA DO PEDIDO</th><th>Total</th><th>ENDEREÇO</th><th>PROVINCIA</th><th>TELEFONE</th><th>ESTADO</th><th>...</th></tr>
				</thead>
	...
	<?php else: ?>
		<h3 style="text-align: center;">usuario sem pedidos</h3>
	<?php endif;?>

<?php else: ?>
	<h3 style="text-align: center;">Não foi possivel encontrar o perfil</h3>
<?php endif;?>
