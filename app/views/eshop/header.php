...
<head>
    ...
    <title><?= $data['page_title']?> | AD-Commerce</title>
						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<?php if(isset($data['user_data']) && $data['user_data']->rank == 'admin'): ?>
									<li><a href="<?=ROOT?>profile"><i class="fa fa-user"></i> Minha Conta</a></li>
								<?php endif; ?>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="<?=ROOT?>shop" class="<?= $page_title == "Shop" ? "active" : ""; ?>">Comprar</a></li> 
								<li class="dropdown"><a href="<?=ROOT?>blog" class="<?= $page_title == "Blog" ? "active" : ""; ?>">Blog</a></li> 
								<li><a href="<?=ROOT?>contact-us" class="<?= $page_title == "Contact-us" ? "active" : ""; ?>">Contactos</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<form method="get">
							<div class="search_box pull-right">
								<input name="find" type="text" placeholder="Pesquisar"/>
							</div>
						</form>
					</div>
					<?php endif; ?>
