<?php $this->view("header",$data); ?>
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Contato <strong>Us</strong></h2>    			    				    				
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				...
	    				<?php if(isset($_GET['success'])):?>
	    					<div class="status alert alert-success" style="">Mensagem enviada com sucesso</div>
	    				<?php endif;?>
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				<h2 class="title text-center">Contato Info</h2>
	    				<address>
